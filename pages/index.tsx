...
export default function Home() {
  return (
    <section className="content-section space-y-6">
      <div className="card">
        <h1 className="text-3xl font-bold">Prompting Techniques — Knowledge Pack v1.2</h1>
      ...
      <div className="card">
        ...
        <ul className="list-disc ml-5 mt-2 space-y-1 text-gray-700">
          <li><Link href="./04-maieutic" className="text-primary hover:underline">Maieutic Prompting — explanation trees & traceability</Link></li>
          <li><Link href="./05-self-refinement" className="text-primary hover:underline">Self-Refinement — iterative critique & polish</Link></li>
          <li><Link href="./06-least-to-most" className="text-primary hover:underline">Least-to-Most — scaffolded decomposition</Link></li>
        </ul>
      </div>
